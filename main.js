...
<div class="main w-100 d-flex py-2 border border-end-0 border-start-0 border-top-0 bg-dark text-white">
    <div class="col-md-3 col-sm-3 border border-left-0 border-top-0 border-bottom-0 d-flex justify-content-between">
       <img src="${img_src}" class="w-50 mx-auto"  alt="">
  </div>

<div id="title" class="col-md-4 col-sm-4 px-2 d-flex flex-wrap align-content-center justify-content-center">
  <h6 style="font-size: 13px; ">${title}</h6>
</div>

<div class="col-md-2 col-sm-2 d-flex flex-wrap align-content-center justify-content-center">
  <span class="mx-2 text-center"> 1 </span>
</div>


<div class="col-md-2 col-sm-2 d-flex flex-wrap align-content-center justify-content-center" id="t_price">
  <h6 class="mt-2 d-flex"><span>$</span> <span class="cart-item-price">${price}</span></h6>
</div>


<div class="col-md-1 col-sm-1 d-flex flex-wrap align-content-center justify-content-center">
